          ...
          <div className="catalog-filter-bar-wrap">
            <div className="catalog-filter-bar">
              ...
              <div className="catalog-filter-inline catalog-filter-inline--category">
                ...
                >
                  {[ALL, ...categories].map((cat) => (
                    <option key={cat} value={cat}>{displayNameFor(cat)}</option>
                  ))}
                </select>
              </div>
            ...
            <div className="catalog-active-filters">
              {selectedCategory !== ALL && (
                <div className="active-filter-chip">
                  ...
                  <button onClick={() => updateFilters({ category: ALL })} aria-label="Quitar filtro de categoría">×</button>
                </div>
              )}
              {selectedType !== ALL && (
                <div className="active-filter-chip">
                  <span>{selectedType}</span>
                  <button onClick={() => updateFilters({ type: ALL })} aria-label="Quitar filtro de tipo">×</button>
                </div>
              )}
            </div>
          )}
